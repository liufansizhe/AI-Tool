...
import { Sparkles, Target, Users, Mail, Github } from 'lucide-react';
        ...
        <section className="bg-gradient-to-b from-blue-50 to-white py-16 md:py-24">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              我们致力于帮助用户发现最实用的 AI 工具，让每个人都能享受 AI 带来的便利
            </p>
          </div>
        </section>
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="text-center p-8 bg-white rounded-2xl border border-gray-100">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-3">服务对象</h3>
                <p className="text-gray-600">
              ...
              <div className="text-center p-8 bg-white rounded-2xl border border-gray-100">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-3">核心价值</h3>
                <p className="text-gray-600">
          ...
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8">
              ...
              <div className="space-y-6 text-gray-600">
                <p>
                  在 AI 工具爆发的时代，每天都会有新的 AI 产品出现。面对琳琅满目的选择，
                  很多用户会感到困惑：哪个工具适合我？哪个更好用？是否免费？
                </p>
                <p>
                  AI工具箱就是为了解决这些问题而诞生的。我们精心筛选全球优质的 AI 工具，
                  按照分类整理，标注清晰的价格信息，让你能够快速找到最适合自己的工具。
                </p>
                <p>
                  我们的目标是成为最值得信赖的 AI 工具导航站，帮助每一位用户在 AI 时代
                  提升效率、释放创造力。
                </p>
              </div>

              <h2 className="text-2xl font-bold text-gray-900 mb-6 mt-12">收录标准</h2>
